...
*/
//std::vector< std::vector<int> > CrecordSwap::orderData(std::vector< std::vector<int> > &data, int orderIndex){
...
*/
//std::vector<int> CrecordSwap::setLevels(std::vector< std::vector<int> > data, std::vector<int> hierarchy, std::vector<int> risk, int hid, int th) {
...
*/
//int CrecordSwap::test(std::vector< std::vector<int> > data, std::vector<int> loop_index) {
...
*/
//std::vector< std::vector<double> > CrecordSwap::setRisk(std::vector<std::vector<int> > data, std::vector<int> hierarchy, std::vector<int> risk, int hid){
...
*/
//std::unordered_set<int> CrecordSwap::randSample(std::unordered_set<int> &ID, int N, std::vector<double> &prob, std::mt19937 &mersenne_engine,
...
*/
//std::vector<std::vector<int> > CrecordSwap::test_randSample(int B,std::vector<int> ID, int N, std::vector<double> prob,int seed){
...
//std::vector<int> CrecordSwap::test_stuff(std::vector<int> vec1){
...
*/
//std::vector<std::vector<int> > CrecordSwap::recordSwap(std::vector< std::vector<int> > data, std::vector<int> similar,
